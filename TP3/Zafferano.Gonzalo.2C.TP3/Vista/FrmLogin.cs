...
namespace Vista
{
    public partial class FrmLogin : Form
    {
        ...
        {
            if (!(bool)this.btnAmpliar.Tag)
            {
                this.Width += 280;
                this.btnAmpliar.Text = "<< Menos";
            }
            else
            {
                this.Width -= 280;
                this.btnAmpliar.Text = "Más >>";
            }

            this.btnAmpliar.Tag = !(bool)this.btnAmpliar.Tag;
        }
         
        private void FrmLogin_Load(object sender, EventArgs e)
        {
            this.btnAmpliar.Tag = false;
        }
        ...
        /// </summary>
        /// <param name="tipoEmpleado">Tipo de empleado que iniciara sesion.</param>
        private void IngresoAutomatico(Empleado.Rol tipoEmpleado)
        {
            ...
            for(int i = 0; i < Administrador.Count; i++)
            {
                ...
                if(empleadoAuxiliar is not null && empleadoAuxiliar.Puesto == tipoEmpleado)
                {
                    empleado = empleadoAuxiliar;
                    break;
                }
            ...
            {
                throw new NullReferenceException($"No hay empleados del tipo '{tipoEmpleado}' cargados en el sistema");
            }
        }
    }
}
